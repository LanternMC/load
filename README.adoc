...
:120-version: https://github.com/LanternMC/load/tree/1.20[an older 1.20 version]
:116-version: https://github.com/LanternMC/load/tree/1.16[an older 1.16 version]
...
This version of Lantern Load will not work correctly in 1.20.6 or older.
If you must release a pack for versions prior to 1.21, please use {120-version} or {116-version} of Lantern Load.
